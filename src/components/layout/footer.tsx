      ...
      <div className="mx-auto max-w-[1280px] px-4 py-12">
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col items-start xl:items-end gap-4">
            ...
            {/* 모바일 앱 다운로드 */}
            <div className="w-full max-w-[460px] rounded-xl border border-slate-700 bg-slate-950/25 p-3">
              <div className="mb-3 flex items-center gap-2 px-1">
                <Smartphone className="h-5 w-5 text-slate-400" />
                <span className="text-sm font-semibold text-slate-200">모바일 앱 다운로드</span>
              </div>
              <div className="space-y-2">
                {appDownloads.map((app) => (
                  <div
                    key={app.name}
                    className="grid gap-2 rounded-lg border border-slate-700/70 bg-slate-800/70 p-2.5 sm:grid-cols-[104px_1fr] sm:items-center"
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <a
                        ...
                        className="flex min-h-10 items-center justify-center gap-2 rounded-lg border border-slate-600 bg-slate-800 px-3 py-2 text-slate-300 transition-colors hover:border-slate-500 hover:bg-slate-700 hover:text-white"
                      >
                        <svg viewBox="0 0 24 24" className="h-4 w-4 shrink-0" fill="currentColor">
                          <path d="M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 0 1-.61-.92V2.734a1 1 0 0 1 .609-.92zm10.89 10.893l2.302 2.302-10.937 6.333 8.635-8.635zm3.199-3.198l2.807 1.626a1 1 0 0 1 0 1.73l-2.808 1.626L15.206 12l2.492-2.491zM5.864 2.658L16.8 8.99l-2.302 2.302-8.634-8.634z" />
                        </svg>
                        <span className="whitespace-nowrap text-xs font-medium">Google Play</span>
                      </a>
                      <a
                        href={app.appStore}
                        target="_blank"
                      ...
                      >
                        ...
                        <span className="whitespace-nowrap text-xs font-medium">App Store</span>
                      </a>
                    </div>
                  </div>
                ))}
