...
const faqs = [
  {
    ...
    a: "에버웰커밍 스탠다드는 무료로 사용 가능하며, 에버타임 스탠다드는 1개월 무료체험 이며, 자동 결제수단 등록 시 6개월 추가 무료 총 7개월로 이용하실 수 있습니다. 홈페이지에서 '무료체험 시작' 버튼을 클릭하시면 3분 내에 포털 생성이 완료됩니다",
  },
  {
  ...
  },
  {
    ...
    a: "에버타임/에버페이롤은 ISO 27001 국제정보보안 인증을 획득하였으며, 모든 데이터는 암호화되어 저장됩니다. 접근권한 관리, 감사로그, 백업 체계를 통해 안전하게 보호됩니다",
  },
]
