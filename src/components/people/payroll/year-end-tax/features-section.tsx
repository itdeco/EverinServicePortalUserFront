...
const features = [
  {
    title: "국세청 PDF 반영",
    desc: "국세청 PDF를 업로드하면 공제 내역을 확인하고\n필요한 항목만 수기로 보완할 수 있습니다.",
    icon: UploadCloud,
  },
  {
    title: "모바일 입력 지원",
    desc: "부양가족, 전 근무지, 개인 인적정보까지\n직원이 모바일에서 직접 입력합니다.",
    icon: Smartphone,
  },
  {
    title: "아웃소싱 처리",
    desc: "연말정산 시즌에만 필요한 업무도\n전문가에게 맡겨 운영 부담을 줄일 수 있습니다.",
    icon: ShieldCheck,
  },
]
  ...
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="mx-auto max-w-[1280px] px-4 md:px-6">
        <div className="mb-10 text-center md:mb-19">
