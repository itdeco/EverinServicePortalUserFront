...
const faqs = [
  ...
  },
  {
    ...
    answer: "네, 가능합니다. 에버인은 기존 ERP, 그룹웨어, 인사시스템과의 연동 및 데이터 마이그레이션 서비스를 제공합니다. 전담 컨설턴트가 배정되어 안전하고 정확한 데이터 이관을 도와드립니다.",
  },
  {
  ...
  },
  {
    ...
    answer: "에버인은 모듈별 과금 방식으로 필요한 기능만 선택하여 비용을 최적화할 수 있습니다. 요금제 페이지에서 실시간 견적을 확인하시거나, 도입 상담을 신청하시면 맞춤형 견적서를 받아보실 수 있습니다.",
  },
  {
    question: "보안 및 개인정보 보호는 어떻게 관리되나요?",
    answer: "에버인은 ISO 27001 국제정보보안 인증을 획득하였으며, 국내 클라우드 보안인증(CSAP)을 준수합니다. 모든 데이터는 암호화되어 저장되며, 접근권한 관리, 감사로그, 백업 체계를 통해 안전하게 보호됩니다.",
  },
]
